...
feb.data$Global_reactive_power <- as.numeric(feb.data$Global_reactive_power)
feb.data$Voltage <- as.numeric(feb.data$Voltage)
...
#The first row and first column plots Global Active Power to DateTime
plot(feb.data$DateTime, feb.data$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power")

#The first row and second column plots Voltage to DateTime
plot(feb.data$DateTime, feb.data$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")

#The second row and first column plots Energy Sub Metering to DateTime
...
#The second row and second column plots Global Reactive Power to DateTime
plot(feb.data$DateTime, feb.data$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
